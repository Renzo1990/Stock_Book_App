 ...
 *
 */
public class CarStat extends VBox {

	@SuppressWarnings("unused")
	private user User;
	private CategoryAxis xAxis;
	private NumberAxis yAxis;
	public CarStat(user User)
	{
	...
	private void topheader1()
	{
		...
		Label lblAddStock = new Label("CAR STATISTICS");
	...
	private ObservableList<Series<String, Integer>> getChartData()
	{
		...
		Series<String, Integer> toyota = new Series<>();
		Series<String, Integer> kia = new Series<>();
		...
		{
			bmw.getData().add(new XYChart.Data<String, Integer>(Integer.toString(i), bmwValue));
			bmwValue = (int)(bmwValue + 4*Math.random() - 0.2);
			toyota.getData().add(new XYChart.Data<String, Integer>(Integer.toString(i), toyotaValue));
			toyotaValue = (int)(toyotaValue + 5*Math.random() - 0.1);
			kia.getData().add(new XYChart.Data<String, Integer>(Integer.toString(i), kiaValue));
			kiaValue = (int)(kiaValue + 3*Math.random() - 0.5);
		}
		data.addAll(bmw, toyota, kia);
